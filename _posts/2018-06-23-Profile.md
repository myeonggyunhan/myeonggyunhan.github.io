...
### <i class="fa fa-book"></i> Publications  
  - Jinsu Park, Seongbeom Park, **Myeonggyun Han**, Jihoon Hyun, and Woongki Baek, *HyPart: A Hybrid Technique for Practical Memory Bandwidth Partitioning on Commodity Servers*, in the Proceedings of the 27th International Conference on Parallel Architectures and Compilation Techniques ([PACT](http://www.pactconf.org/index.php)), Nov. 2018 (to appear).  
